...
<report name="Donor" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL DONOR.DONOR_ID, DONOR.PASSWORD, DONOR.D_EMAIL, DONOR.F_NAME, DONOR.L_NAME
FROM DONOR ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_DONOR_ID">
        <displayInfo x="1.37732" y="1.94995" width="1.24548" height="1.15942"
        />
        <dataItem name="DONOR_ID" datatype="vchar2" columnOrder="11"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Donor Id">
          <dataDescriptor expression="DONOR.DONOR_ID"
           descriptiveExpression="DONOR_ID" order="1" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PASSWORD" datatype="vchar2" columnOrder="12"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Password">
          <dataDescriptor expression="DONOR.PASSWORD"
           descriptiveExpression="PASSWORD" order="2" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="D_EMAIL" datatype="vchar2" columnOrder="13" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="D Email">
          <dataDescriptor expression="DONOR.D_EMAIL"
           descriptiveExpression="D_EMAIL" order="3" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="F_NAME" datatype="character"
         oracleDatatype="aFixedChar" columnOrder="14" defaultWidth="100000"
         defaultHeight="10000" columnFlags="33" defaultLabel="F Name">
          <dataDescriptor expression="DONOR.F_NAME"
           descriptiveExpression="F_NAME" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="L_NAME" datatype="character"
         oracleDatatype="aFixedChar" columnOrder="15" defaultWidth="100000"
         defaultHeight="10000" columnFlags="33" defaultLabel="L Name">
          <dataDescriptor expression="DONOR.L_NAME"
           descriptiveExpression="L_NAME" order="5" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
      ...
      <frame name="M_G_DONOR_ID_GRPFR">
        ...
        <repeatingFrame name="R_G_DONOR_ID" source="G_DONOR_ID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_DONOR_ID" source="DONOR_ID" minWidowLines="1"
          ...
          <field name="F_D_EMAIL" source="D_EMAIL" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
          ...
          <field name="F_F_NAME" source="F_NAME" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="4.50000" y="0.18750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_L_NAME" source="L_NAME" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="6.00000" y="0.18750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_DONOR_ID_HDR">
          ...
          <text name="B_DONOR_ID" minWidowLines="1">
          ...
          <text name="B_D_EMAIL" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_F_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.50000" y="0.00000" width="1.50000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_L_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="6.00000" y="0.00000" width="1.50000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwblue" sectionTitle="Donor Sammary"/>
  <reportWebSettings>
  <![CDATA[]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGDONORIDGRPFR139">
<table class="OraTable">
<caption> Donor Sammary </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBDONORID139" asArray="no"/> class="OraColumnHeader"> Donor Id </th>
   <th <rw:id id="HBPASSWORD139" asArray="no"/> class="OraColumnHeader"> Password </th>
   <th <rw:id id="HBDEMAIL139" asArray="no"/> class="OraColumnHeader"> D Email </th>
   <th <rw:id id="HBFNAME139" asArray="no"/> class="OraColumnHeader"> F Name </th>
   <th <rw:id id="HBLNAME139" asArray="no"/> class="OraColumnHeader"> L Name </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGDONORID1391" src="G_DONOR_ID">
   <tr>
    <td <rw:headers id="HFDONORID139" src="HBDONORID139"/> class="OraCellText"><rw:field id="FDONORID139" src="DONOR_ID" nullValue="&nbsp;"> F_DONOR_ID </rw:field></td>
    <td <rw:headers id="HFPASSWORD139" src="HBPASSWORD139"/> class="OraCellText"><rw:field id="FPASSWORD139" src="PASSWORD" nullValue="&nbsp;"> F_PASSWORD </rw:field></td>
    <td <rw:headers id="HFDEMAIL139" src="HBDEMAIL139"/> class="OraCellText"><rw:field id="FDEMAIL139" src="D_EMAIL" nullValue="&nbsp;"> F_D_EMAIL </rw:field></td>
    <td <rw:headers id="HFFNAME139" src="HBFNAME139"/> class="OraCellText"><rw:field id="FFNAME139" src="F_NAME" nullValue="&nbsp;"> F_F_NAME </rw:field></td>
    <td <rw:headers id="HFLNAME139" src="HBLNAME139"/> class="OraCellText"><rw:field id="FLNAME139" src="L_NAME" nullValue="&nbsp;"> F_L_NAME </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
